...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            ...
                            runningmsg="Running...",
                            loadingmsg="Loading...",
                            ifremovefailmsg="Remove Gnome Builder Failed",
                            ifinstallfailmsg="Install Gnome Builder Failed",
                            ifinstallsucessmsg="Install Gnome Builder Done",
    ...
    def check(self):
        self.package_name = "org.gnome.Builder"
