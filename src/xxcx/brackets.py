...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            spacing=2,
                            margin=10,
                            button_image="brackets.png",
                            button_install_label="Install Brackets (Flatpak User wide)",
                            button_remove_label="Remove Brackets (Flatpak User wide)",
                            buttontooltip="Install Remove Brackets (Flatpak User wide)",
                            buttonsizewidth=100,
                            ...
                            runningmsg="Running...",
                            loadingmsg="Loading...",
                            ifremovefailmsg="Remove Brackets Failed",
                            ifinstallfailmsg="Install Brackets Failed",
                            ifinstallsucessmsg="Install Brackets Done",
                            ifremovesucessmsg="Remove Brackets Done",
                            beforeinstallyesorno="Start Install Brackets ?",
                            beforeremoveyesorno="Start Remove Brackets ?",
                            expand=False,
                            daemon=True)
    ...
    def check(self):
        self.package_name = "io.brackets.Brackets"
