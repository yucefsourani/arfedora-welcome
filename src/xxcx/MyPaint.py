...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            spacing=2,
                            margin=10,
                            button_image="mypaint.png",
                            button_install_label="Install MyPaint (Flatpak User wide)",
                            button_remove_label="Remove MyPaint (Flatpak User wide)",
                            buttontooltip="Install Remove MyPaint (Flatpak User wide)",
                            buttonsizewidth=100,
                            ...
                            runningmsg="Running...",
                            loadingmsg="Loading...",
                            ifremovefailmsg="Remove MyPaint Failed",
                            ifinstallfailmsg="Install MyPaint Failed",
                            ifinstallsucessmsg="Install MyPaint Done",
                            ifremovesucessmsg="Remove MyPaint Done",
                            beforeinstallyesorno="Start Install MyPaint ?",
                            beforeremoveyesorno="Start Remove MyPaint ?",
                            expand=False,
                            daemon=True)
    ...
    def check(self):
        self.package_name = "org.mypaint.MyPaint"
