...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            ...
                            button_install_label="Install blender  (Flatpak User wide)",
                            button_remove_label="Remove blender (Flatpak User wide)",
                            buttontooltip="Install Remove blender (Flatpak User wide)",
                            buttonsizewidth=100,
                            ...
                            ifinstallsucessmsg="Install blender Done",
                            ifremovesucessmsg="Remove blender Done",
                            beforeinstallyesorno="Start Install blender ?",
                            beforeremoveyesorno="Start Remove blender ?",
                            expand=False,
                            daemon=True)
    ...
    def check(self):
        self.package_name = "org.blender.Blender"
