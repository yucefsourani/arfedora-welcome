...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            spacing=2,
                            margin=10,
                            button_image="sublime.png",
                            button_install_label="Install Sublime Text (Flatpak User wide)",
                            button_remove_label="Remove Sublime Text (Flatpak User wide)",
                            buttontooltip="Install Remove Sublime Text (Flatpak User wide)",
                            buttonsizewidth=100,
                            ...
                            runningmsg="Running...",
                            loadingmsg="Loading...",
                            ifremovefailmsg="Remove Sublime Text Failed",
                            ifinstallfailmsg="Install Sublime Text Failed",
                            ifinstallsucessmsg="Install Sublime Text Done",
                            ifremovesucessmsg="Remove Sublime Text Done",
                            beforeinstallyesorno="Start Install Sublime Text ?",
                            beforeremoveyesorno="Start Remove Sublime Text ?",
                            expand=False,
                            daemon=True)
    ...
    def check(self):
        self.package_name = "com.sublimetext.three"
