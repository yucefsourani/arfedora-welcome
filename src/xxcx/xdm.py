...
class Plugin(BasePlugin):
    __gtype_name__ = utils.get_uniq_name(__file__) #uniq name and no space
    ...
    def remove(self):
        ...
        to_run = utils.write_to_tmp(commands)
    ...
    def __download(self,link,location):
        GLib.idle_add(self.__mainbox__.add,self.__progressbar__)
