...
class Plugin(BasePlugin):
    ...
    def __init__(self,parent):
        BasePlugin.__init__(self,parent=parent,
                            spacing=2,
                            margin=10,
                            button_image="pycharmcommunity.png",
                            button_install_label="Install PyCharm Community (Flatpak User wide)",
                            button_remove_label="Remove PyCharm Community (Flatpak User wide)",
                            buttontooltip="Install Remove PyCharm Community (Flatpak User wide)",
                            buttonsizewidth=100,
                            ...
                            runningmsg="Running...",
                            loadingmsg="Loading...",
                            ifremovefailmsg="Remove PyCharm Community Failed",
                            ifinstallfailmsg="Install PyCharm Community Failed",
                            ifinstallsucessmsg="Install PyCharm Community Done",
                            ifremovesucessmsg="Remove PyCharm Community Done",
    ...
    def check(self):
        self.package_name = "com.jetbrains.PyCharm-Community"
